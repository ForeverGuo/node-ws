...
wss.on('connection', function(ws) {
	...
	child_process.exec('python /home/gys/baidu-tts/tts.py '+message+' /var/www/html/ws/video'+math+'.mp3',function(err,stdout,stderr){
		if(err){console.log(error.stack);}
		
	       getResult('<audio src="video'+math+'.mp3" controls="controls" />'); 
	})
    	console.log(message);
	//getResult(message); 
